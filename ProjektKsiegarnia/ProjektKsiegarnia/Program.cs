...
namespace ProjektKsiegarnia
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            pracownik1.iloscSprzedazy = 2;
            Ksiazka ksiazka1 = new Ksiazka("WładcaPierścieni", "J.R.R.Tolkien", 2010, 22.50, 50);
            Ksiazka ksiazka2 = new Ksiazka("PilotCiTegoNiePowie", "PatrickSmith", 2018, 25, 15);
            Ksiazka ksiazka3 = new Ksiazka("PanTadeusz", "AdamMickiewicz", 2000, 20.99, 37);
            Ksiazka ksiazka4 = new Ksiazka("Wiedźmin", "AndrzejSapkowski", 2012, 27.80, 4);
